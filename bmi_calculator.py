...
class BodyMassIndexCalculator:
    """
    Body Mass Calculator is a personal project that I just developed for fun and hoping that it can help you
    with computing your Body Mass Index in order to know if you are overweight, . 
    """
